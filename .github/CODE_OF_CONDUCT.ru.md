...
О фактах нарушения или иных прецедентах неприемлемого поведения сообщайте команде проекта по [электронной почте][адрес электронной почты]. 
Команда проекта рассматривает и изучает жалобы, и реагирует соответствующим образом, целесообразным при данных обстоятельствах. Команда проекта обязуется сохранять конфиденциальность в отношении автора обращения. Подробная информация о политике претензий может быть размещена отдельно.
...
Для ответа на частые вопросы о данном Кодексе Поведения смотрите https://www.contributor-covenant.org/faq


[сайт]: https://www.contributor-covenant.org
[адрес электронной почты]: mailto:cognitivim@gmail.com
